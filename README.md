...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/asdf-transform-schemas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15573&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/asdf-transform-schemas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `asdf-transform-schemas` can be installed with:

```
conda install asdf-transform-schemas
```

It is possible to list all of the versions of `asdf-transform-schemas` available on your platform with:
